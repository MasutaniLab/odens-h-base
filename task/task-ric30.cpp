///
///@file task-ric30.cpp
///@brief RIC30用 Taskクラスのメンバ関数の定義（公開用）
///@par Copyright
...
namespace odens {
  ...
  ///@retval true 倒れている
  ///
  bool TaskRIC30::isLying(const srInfo &info) {
  ...
  ///@return 終了状態
  ///
  int TaskRIC30::standUp(const srInfo &info, double ctime)
  {
  ...
  ///@return 終了状態
  ///
  int TaskRIC30::move(const srInfo &info, const Orthogonal &target)
  {
    Command com;
