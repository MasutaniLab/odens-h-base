...
namespace odens {
  ...
  ///@retval true 倒れている
  ///
  bool TaskKHR3::isLying(const srInfo &info) {
  ...
  ///@return 終了状態
  ///
  int TaskKHR3::standUp(const srInfo &info, double ctime)
  {
